...
const CARD_LOGO_URLS: {[key: string]: string} = {
...
interface AtmCardProps {
  ...
  pan?: string;
  exp?: string;
  style?: any; // Adjust this type as per your actual style props type
}
  ...
  return (
    <LinearGradient colors={colors} style={cardStyle}>
      ...
      <Text
        ...
        white
        style={{
          fontFamily: FONT_FAMILY_CREDIT_CARD,
          fontSize: 18,
          letterSpacing: 1.3,
          marginBottom: 12,
          opacity: 0.2,
      ...
      <View
        ...
        <Text
          ...
          {cardNumber ? cardNumber.toUpperCase() : null}
        </Text>
        <Text right small white style={{letterSpacing: 1.3}}>
          {exp}
        </Text>
      </View>
      <View
